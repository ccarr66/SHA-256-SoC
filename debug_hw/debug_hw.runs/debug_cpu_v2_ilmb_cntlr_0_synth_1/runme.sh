...
HD_PWD='/home/connor/Documents/Programs/Vivado/4300/SHA-256-SoC/debug_hw/debug_hw.runs/debug_cpu_v2_ilmb_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debug_cpu_v2_ilmb_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debug_cpu_v2_ilmb_cntlr_0.tcl
