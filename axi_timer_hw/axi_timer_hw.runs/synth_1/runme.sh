...
HD_PWD='/home/connor/Documents/Programs/Vivado/4300/SHA-256-SoC/axi_timer_hw/axi_timer_hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_cpu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_cpu_wrapper.tcl
